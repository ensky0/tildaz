...
#
#   tool/stress/measure-idle-latency.sh                 # 기본 — 20 회 · 간격 2 초
...
usage() {
    cat <<'USAGE'
쓰는 법: tool/stress/measure-idle-latency.sh [옵션]
...
# **측정 위생을 지킨다.** `check-input-loss_linux_macos.sh` 는 판정이 "먹었나 / 안 먹었나" 라는 이산값이라
