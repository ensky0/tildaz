...
| SIGHUP 무시 셸 fallback | SIGKILL 강제 | (자동) | 미구현 (`nohup` wrapper 같은 rare 케이스만 hang) | ✅ | 🟨 #129 |
...
| SIGHUP 무시 셸 fallback (SIGKILL) | 🟨 | #129 | `nohup` wrapper 같은 rare 케이스 — deinit hang 회피. timed wait + SIGKILL. |
