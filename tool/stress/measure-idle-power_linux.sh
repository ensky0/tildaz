...
#
#   sudo tool/stress/measure-idle-power_linux.sh                  # 기본 — 구간 60 초 × 4
#   sudo tool/stress/measure-idle-power_linux.sh --duration 120
#
...
usage() {
    cat <<'USAGE'
쓰는 법: sudo tool/stress/measure-idle-power_linux.sh [옵션]
