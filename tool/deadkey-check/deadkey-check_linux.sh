...
#
#   ./tool/deadkey-check/deadkey-check_linux.sh --bin ./zig-out/bin/tildaz                     # LANG 은 현재 값
#   ./tool/deadkey-check/deadkey-check_linux.sh --bin ./zig-out/bin/tildaz --lang xx_XX.UTF-8  # 없는 locale → en_US.UTF-8 fallback
#   ./tool/deadkey-check/deadkey-check_linux.sh --bin ./zig-out/bin/tildaz --strace            # tildaz 의 write() 까지 기록
#   ./tool/deadkey-check/deadkey-check_linux.sh --bin ./zig-out/bin/tildaz --case pane-exit    # #583 B14 — 활성 pane 의 셸이 스스로 끝날 때 조합을 버리는지
#
