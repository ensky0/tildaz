...
| **word boundary 문자** (cross-platform 동일) | cell 영역 | `terminal_interaction.word_boundaries` | 동일 모듈 | ✅ | ✅ |
...
> **word boundary 문자 (cross-platform 동일):** [`terminal_interaction.zig:69`](src/terminal_interaction.zig#L69)
>
> `space, tab, " ` | : ; ( ) [ ] { } < >`
>
> 더블클릭 시 ghostty `screen.selectWord(pin, &word_boundaries)` 가 cursor 위치에서 양쪽으로 boundary 문자까지 확장 — 한쪽 platform 에 추가/삭제하면 양쪽 즉시 반영.
