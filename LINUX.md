...
- **sway** — nested sway 1.12 (KDE Wayland 안) 에서 layer-shell drop-down + hotkey 자동 등록 (#207, `bindsym`) 시연 완료 (2026-05-31). **Hyprland 는 미시연** — *Support Tier 정의* 에서 wlroots 계열을 *Full-support target* 으로 분류했지만 Hyprland 실 시연 0 회 (portal GlobalShortcuts 재사용 예정, #207 후속).
