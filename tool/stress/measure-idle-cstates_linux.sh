...
#
#   tool/stress/measure-idle-cstates_linux.sh                  # 기본 — 구간 60 초 × 4
#   tool/stress/measure-idle-cstates_linux.sh --duration 120
#
...
usage() {
    cat <<'USAGE'
쓰는 법: tool/stress/measure-idle-cstates_linux.sh [옵션]
